...
<table style="background-color:#D8BFD8;text-align: left; width: 1301px; height: 250px; margin-left: auto; margin-right: auto;" border="0" cellpadding="0" cellspacing="0">
 ...
 <td  style="text-align:right">
      ...
      <button type="submit" name="logout" style="padding: 8px; background: rgb(14, 0, 43) none repeat scroll 0% 50%; color: white; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; font-size: 16px;">LOG OUT</button>
      <?php 
...
function processInput($data){ 
    ...
    <td><a href="shopping-cart.php?id=<?php echo $row['ID'];?>" style="color:white; width:100px; height:30px;" type='submit' class='button a' >ADD CART</a></td>
